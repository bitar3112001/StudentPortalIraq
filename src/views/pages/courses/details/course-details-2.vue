            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-sm-3 gap-xl-4 flex-wrap justify-content-md-start justify-content-center">
                        <p class="fw-medium text-white d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/book.svg" alt="img">12+ Lesson</p>
                        <p class="fw-medium text-white d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/timer-start.svg" alt="img">9hr 30min</p>
                        <p class="fw-medium text-white d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/people.svg" alt="img">32 students enrolled</p>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-sm-between mt-5">
                        <div class="d-flex text-start align-items-center justify-content-sm-start justify-content-center">
                            ...
                            <div class="ms-2">
                            <h6 class="fs-18 text-white"><router-link to="/pages-instructor/instructor-details">Nicole Brown</router-link></h6>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="accordion accordion-customicon1 accordions-items-seperate p-0" id="accordioncustomicon1Example">
                        ...
                        <div class="course-info align-items-center d-flex gap-2 gap-xl-3 mt-3 mb-3 flex-wrap">
                            <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2" src="@/assets/img/icons/play2.svg" alt="img">5Courses</p>
                    ...
                    <div class="stickysidebar">
                        <div class="course-sidebar-sec">
                            ...
                            <div class="card-body">
                                ...
                                <router-link to="/courses/cart" class="btn btn-primary w-100 mt-4 btn-enroll">Enroll Now</router-link>
                            </div>
                            </div>
                            <div class="card">
                            <div class="card-body">
                                <h5 class="subs-title">Includes</h5>
                                <p><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">11 hours on-demand video</p>
                                <p><img class="me-2" src="@/assets/img/icons/import.svg" alt="img">69 downloadable resources</p>
                                <p><img class="me-2" src="@/assets/img/icons/key.svg" alt="img">Full lifetime access</p>
                                <p><img class="me-2" src="@/assets/img/icons/monitor-mobbile.svg" alt="img">Access on mobile and TV</p>
                                <p><img class="me-2" src="@/assets/img/icons/cloud-lightning.svg" alt="img">Assignments</p>
