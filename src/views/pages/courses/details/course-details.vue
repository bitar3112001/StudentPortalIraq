                ...
                <div class="col-md-12 col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><router-link to="/home/index">Home</router-link></li>
                        ...
                        <div class="card-body d-lg-flex align-items-center">
                            ...
                            <div class="w-100 ps-lg-4">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-sm-3 gap-xl-4 flex-wrap my-3 my-sm-0">
                                    <p class="fw-medium d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/book.svg" alt="img">12+ Lesson</p>
                                    <p class="fw-medium d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/timer-start.svg" alt="img">9hr 30min</p>
                                    <p class="fw-medium d-flex align-items-center mb-0"><img class="me-2" src="@/assets/img/icons/people.svg" alt="img">32 students enrolled</p>
                                ...
                                <div class="d-sm-flex align-items-center justify-content-sm-between mt-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                        <h5 class="fs-18 fw-semibold"><router-link to="/pages-instructor/instructor-details">Nicole Brown</router-link></h5>
                                            ...
                                            <div class="accordion-body p-0">
                                                <ul>
                                                    <li class="p-4 px-3 d-flex justify-content-between">
                                                        <p class="mb-0"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">Lecture1.1 Introduction to the User Experience Course</p>   
                                                    ...
                                                    <li class="p-4 px-3 d-flex justify-content-between">
                                                        <p class="mb-0"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">Lecture1.2 Exercise: Your first design challenge</p>   
                                                        <div class="d-flex gap-xl-5 gap-3">
                                                        <a href="#" class="preview-link">Preview</a>
                                                        <p class="mb-0">02:53</p>
                                                        </div>
                                                    ...
                                                    <li class="p-4 px-3 d-flex justify-content-between">
                                                        <p class="mb-0"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">Lecture1.3 How to solve the previous exercise</p>   
                                                        <div class="d-flex gap-xl-5 gap-3">
                                                        <a href="#" class="preview-link">Preview</a>
                                                        <p class="mb-0">02:53</p>
                                                        </div>
                                                    ...
                                                    <li class="p-4 px-3 d-flex justify-content-between">
                                                        <p class="mb-0"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">Lecture1.4 Find out why smart objects are amazing</p>   
                                                        <div class="d-flex gap-xl-5 gap-3">
                                                        <a href="#" class="preview-link">Preview</a>
                                                        <p class="mb-0">02:53</p>
                                                        </div>
                                                    ...
                                                    <li class="p-4 px-3 d-flex justify-content-between">
                                                        <p class="mb-0"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">Lecture1.5 How to use text layers effectively</p>   
                                                        <div class="d-flex gap-xl-5 gap-3">
                                                        <a href="#" class="preview-link">Preview</a>
                                                        <p class="mb-0">02:53</p>
                                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4 gap-2 flex-wrap">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                        <router-link to="/pages-instructor/instructor-details" class="name-link">Nicole Brown</router-link>
                                ...
                                <div class="course-info align-items-center d-flex gap-2 gap-xl-3 mt-3 mb-3 flex-wrap">
                                    <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2" src="@/assets/img/icons/play2.svg" alt="img">5 Courses</p>
                                    <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2" src="@/assets/img/icons/book2.svg" alt="img">12+ Lesson</p>
                                    <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2" src="@/assets/img/icons/timer-start2.svg" alt="img">9hr 30min</p>
                                    <p class="fw-medium d-flex align-items-center fs-14 mb-0"><img class="me-2" src="@/assets/img/icons/people.svg" alt="img">270,866 students enrolled</p>
                                </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between gap-3 wishlist-btns">
                                        <router-link class="btn d-flex btn-wish" to="/students/student-wishlist"><i class="isax isax-heart me-1 fs-18"></i>Add to Wishlist</router-link>
                                        <a class="btn d-flex btn-wish" href="#"><i class="ti ti-share me-1 fs-18"></i>Share</a>
                                    </div>
                                    <router-link to="/courses/cart" class="btn btn-primary w-100 mt-3 btn-enroll">Enroll Now</router-link>
                                </div>
                            </div>
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h5 class="subs-title mb-4">Includes</h5>
                                    <p class="mb-3"><img class="me-2" src="@/assets/img/icons/play.svg" alt="img">11 hours on-demand video</p>
                                    <p class="mb-3"><img class="me-2" src="@/assets/img/icons/import.svg" alt="img">69 downloadable resources</p>
                                    <p class="mb-3"><img class="me-2" src="@/assets/img/icons/key.svg" alt="img">Full lifetime access</p>
                                    <p class="mb-3"><img class="me-2" src="@/assets/img/icons/monitor-mobbile.svg" alt="img">Access on mobile and TV</p>
                                    <p class="mb-3"><img class="me-2" src="@/assets/img/icons/cloud-lightning.svg" alt="img">Assignments</p>
                                    <p class="mb-0"><img class="me-2" src="@/assets/img/icons/teacher.svg" alt="img">Certificate of Completion</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body cou-features">
                                    ...
                                    <ul>
                                        <li><p class="mb-0"><img class="me-2" src="@/assets/img/icons/people2.svg" alt="img">Enrolled: 32 students</p></li>
                                        <li><p class="mb-0"><img class="me-2" src="@/assets/img/icons/timer-start3.svg" alt="img">Duration: 20 hours</p></li>
                                        <li><p class="mb-0"><img class="me-2" src="@/assets/img/icons/note.svg" alt="img">Chapters: 15</p></li>
                                        <li><p class="mb-0"><img class="me-2" src="@/assets/img/icons/play3.svg" alt="img">Video: 12 hours</p></li>
                                        <li><p class="mb-0"><img class="me-2" src="@/assets/img/icons/chart.svg" alt="img">Level: Beginner</p></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
