                            ...
                            <div class="checkout-item-3 bg-light p-3 rounded-3 border mb-3">
                                <div class="row row-gap-2 mb-3">
                                    <div class="col-md-12 d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-2"><router-link to="/details/course-details-1">Information About UI/UX Design Degree</router-link></h6>
                                ...
                                <div class="row row-gap-2">
                                    <div class="col-md-12 d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-2"><router-link to="/details/course-details-1">Sketch from A to Z (2024): Become an app designer</router-link></h6>
