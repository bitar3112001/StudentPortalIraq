    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-12">
          <h2 class="breadcrumb-title mb-2">Blog 3 Grid</h2>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center mb-0">
              <li class="breadcrumb-item">
                <router-link to="/home/index">Home</router-link>
              </li>
              <li class="breadcrumb-item active" aria-current="page">Blog 3 Grid</li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <h5 class="mb-2">
                <router-link to="/blogs/blog-details"
                  >Learn Web App Development from Experts in 2024</router-link
                >
              </h5>
              <p class="text-truncate line-clamb-2">
                Master the art of web application development with expert-led courses that
                cover the latest tools, fram...
              </p>
              <div class="blog-info">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <p class="text-truncate line-clamb-2">
                Unlock limitless career opportunities by mastering Python, one of the most
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <p class="text-truncate line-clamb-2">
                Master PHP programming with our comprehensive career guideline! Learn the
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <h5 class="mb-2">
                <router-link to="/blogs/blog-details"
                  >The Complete JavaScript Course for Beginners</router-link
                >
              </h5>
              <p class="text-truncate line-clamb-2">
                Dive into the world of JavaScript with our complete beginner-friendly
                course! Learn essential concepts...
              </p>
              <div class="blog-info">
                <div
                  class="d-flex align-items-center flex-wrap justify-content-between gap-2"
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <h5 class="mb-2">
                <router-link to="/blogs/blog-details"
                  >Programming Content Guideline For Beginners</router-link
                >
              </h5>
              <p class="text-truncate line-clamb-2">
                Kickstart your programming journey with beginner-friendly guidelines
                designed to simplify coding ...
              </p>
              <div class="blog-info">
                <div
                  class="d-flex align-items-center flex-wrap justify-content-between gap-2"
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <h5 class="mb-2">
                <router-link to="/blogs/blog-details"
                  >Revolutionize Learning with a Modern LMS</router-link
                >
              </h5>
              <p class="text-truncate line-clamb-2">
                Discover how a Learning Management System (LMS) can transform education
                and corporate training by ...
              </p>
              <div class="blog-info">
                <div
                  class="d-flex align-items-center flex-wrap justify-content-between gap-2"
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <p class="text-truncate line-clamb-2">
                An LMS streamlines training and development with centralized resources,
                progress tracking, and flexible..
              </p>
              <div class="blog-info">
                <div
                  class="d-flex align-items-center flex-wrap justify-content-between gap-2"
        ...
        <div class="col-xl-4 col-md-6">
          <div class="blog">
            ...
            <div class="blog-item">
              ...
              <h5 class="mb-2">
                <router-link to="/blogs/blog-details"
                  >Transform Education with the Power of an LMS</router-link
                >
              </h5>
              <p class="text-truncate line-clamb-2">
                Explore how an LMS creates engaging, personalized learning experiences
                while simplifying course ...
              </p>
              <div class="blog-info">
                <div
                  class="d-flex align-items-center flex-wrap justify-content-between gap-2"
