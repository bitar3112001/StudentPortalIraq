    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-12">
          <h2 class="breadcrumb-title mb-2">Blog Right Sidebar</h2>
              ...
              <div class="blog">
                ...
                <div class="blog-item">
                  ...
                  <p class="text-truncate line-clamb-2">
                    Master the art of web application development with expert-led courses
                    that cover the latest tools, fram...
                  </p>
                  <div class="blog-info">
                    <div
                    ...
                    >
                      <div class="d-flex align-items-center user-profile">
                        <router-link
                          to="/pages-instructor/instructor-details"
                          class="user-img"
                          ><img
            ...
            <div class="col-md-6">
              <div class="blog">
                ...
                <div class="blog-item">
                  ...
                  <p class="text-truncate line-clamb-2">
                    Unlock limitless career opportunities by mastering Python, one of the
            ...
            <div class="col-md-6">
              <div class="blog">
                ...
                <div class="blog-item">
                  ...
                  <p class="text-truncate line-clamb-2">
                    Master PHP programming with our comprehensive career guideline! Learn
