        ...
        <div class="col-lg-9">
          ...
          <div class="page-title d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center list-icons">
              <router-link to="/instructor/instructor-course" class="me-2"
                ><i class="isax isax-task"></i
              ></router-link>
              <router-link to="/instructor/instructor-course-grid"
              ...
              <div class="row">
                <div class="col-xl-4 col-md-6">
                  <div class="course-item course-item-three">
                    <div
                      class="position-relative overflow-hidden rounded-3 mb-3 course-image"
                    >
                      <a href="javascript:void(0);"
                        ><img
                          ...
                          alt="img"
                      /></a>
                      <span class="fs-20 price-top d-inline-flex align-items-center"
                        >$200 <del class="fs-14 ms-2">$990.00</del></span
                      >
                    </div>
                    <h6 class="mt-3 mb-3 fs-18 fw-bold text-truncate line-clamb-2">
                      <a href="javascript:void(0);"
                    ...
                    >
                      <span class="d-inline-flex align-items-center text-gray-5"
                        ><img src="@/assets/img/icon/book-3.svg" class="me-1" alt="" />12+
                        Lesson</span
                      >
                      <span class="d-inline-flex align-items-center text-gray-5"
                        ><img
                    ...
                    <div class="d-flex justify-content-between mt-3 align-items-center">
                      <a
                        href="#"
                        class="d-inline-flex align-items-center fs-14 text-gray-5"
                      ...
                      <a
                        href="#"
                        class="d-inline-flex align-items-center fs-14 text-gray-5"
                        ><i class="isax isax-edit-2 me-2"></i>Edit</a
                      >
                    </div>
                  </div>
                </div>
                <div class="col-xl-4 col-md-6">
                  <div class="course-item course-item-three">
                    ...
                    <h6 class="mt-3 mb-3 fs-18 fw-bold text-truncate line-clamb-2">
                      <a href="javascript:void(0);"
                        >Wordpress for Beginners - Master Wordpress Quickly</a
                      >
                    </h6>
                    <div
                      class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3"
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="course-item course-item-three">
                    ...
                    >
                      ...
                      /></a>
                      <span
                        class="fs-20 price-top d-inline-flex text-success align-items-center"
                        >Free</span
                      >
                    </div>
                    <h6 class="mt-3 mb-3 fs-18 fw-bold text-truncate line-clamb-2">
                      <a href="javascript:void(0);"
                        >Sketch from A to Z (2022): Become an app designer</a
                      >
                    </h6>
                    <div
                      class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3"
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="course-item course-item-three">
                    ...
                    <h6 class="mt-3 mb-3 fs-18 fw-bold text-truncate line-clamb-2">
                      <a href="javascript:void(0);"
                        >Learn Angular Fundamental From beginning to adv</a
                      >
                    </h6>
                    <div
                      class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3"
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="course-item course-item-three">
                    ...
                    <h6 class="mt-3 mb-3 fs-18 fw-bold text-truncate line-clamb-2">
                      <a href="javascript:void(0);"
                        >C# Developers Double Your Coding Speed</a
                      >
                    </h6>
                    <div
                      class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3"
