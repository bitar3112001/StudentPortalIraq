<template>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-12">
          <h2 class="breadcrumb-title mb-2">Referrals</h2>
              ...
              <div class="student-info bg-skyblue-transparent referral-card border-0">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <span class="fs-20 fw-semibold mb-1 d-block text-skyblue"
                      >$12,000</span
                    >
              ...
              <div class="student-info border-0 bg-secondary-transparent referral-card">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <span class="fs-20 fw-semibold mb-1 d-block text-secondary"
                      >$15,000</span
                    >
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    <input
                      type="text"
                      class="form-control"
                      value="https://dreamslmscourse.com/refer/?refid=345re667877k9"
                    />
                  </div>
            ...
            <div class="col-xl-6 d-flex">
              <div class="card flex-fill">
                <div class="card-body">
                  ...
                  <ul class="mb-4">
                    <li class="mb-2">Withdraw securely to your bank account.</li>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Thompson Hicks</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                    $1https://dreamslmscourse.com/reffer/? <br />
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Jennifer Tovar</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                    $1https://dreamslmscourse.com/reffer/? <br />refid=345re667877k960
                  </td>
                  <td>
                    <a href="#" class="action-icon"
                      ><i class="isax isax-document-copy4"></i
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">James Schulte</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Kristy Cardona</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">William Aragon</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Shirley Lis</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">John Brewer</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Doris Hughes</p></router-link
                      >
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <router-link to="/pages-instructor/instructor-details"
                        ><p class="fs-14">Sarah Martinez</p></router-link
                      >
                    </div>
                  </td>
                  <td>
  ...
  <!-- /Footer -->
  <student-referral-modal></student-referral-modal>
</template>
