          ...
          <fieldset id="first-field">
            ...
            <div class="quiz-attempt-card border-0">
              <div class="quiz-attempt-body p-0">
                ...
                <div class="text-end">
                  <button type="button" class="btn btn-secondary rounded-pill next_btn">
                    Next<i class="isax isax-arrow-right-3 ms-1 fs-10"></i>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="quiz-attempt-body p-0">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <a
                    ...
                    class="btn bg-gray-100 d-inline-flex rounded-pill align-items-center prev_btn me-1"
                    ><i class="isax isax-arrow-left-2 me-1 fs-10"></i>Previous</a
                  >
                  <button type="button" class="btn btn-secondary rounded-pill next_btn">
                    Next<i class="isax isax-arrow-right-3 ms-1 fs-10"></i>
                  </button>
                  ...
                  <div class="mb-0">
                    ...
                    <div class="form-check mb-2">
                      <input
                        ...
                        id="Radio-sm-10"
                      />
                      <label class="form-check-label" for="Radio-sm-10"> Figma </label>
                    </div>
                    <div class="form-check mb-2">
                      <input
                        class="form-check-input"
                    ...
                    <div class="form-check mb-0">
                      <input
                        ...
                        id="Radio-sm-12"
                      />
                      <label class="form-check-label" for="Radio-sm-12"> GitHub </label>
                    </div>
                  </div>
                </div>
                <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="quiz-attempt-card border-0">
              <div class="quiz-attempt-body p-0">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <a
                    href="javascript:void(0);"
                    class="btn btn-light d-inline-flex rounded-pill align-items-center prev_btn me-1"
                    ><i class="isax isax-arrow-left-2 me-1 fs-10"></i>Back</a
                  >
                  <button type="button" class="btn btn-secondary rounded-pill next_btn">
                    Next<i class="isax isax-arrow-right-3 ms-1 fs-10"></i>
                  </button>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <router-link
                    to="/students/student-dashboard"
                    class="btn btn-secondary rounded-pill"
                    ><i class="isax isax-arrow-left-2 me-1 fs-10"></i>Back to
