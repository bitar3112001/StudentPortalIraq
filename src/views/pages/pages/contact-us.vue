          ...
          <div class="col-lg-6">
            <div class="contact-details">
              <div class="section-header">
                ...
                <p>
                  Get in touch with us to explore how our LMS solution can enhance your
                  e-learning experience. We're here to help you build a seamless and
                ...
                <form>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <label class="form-label"
                          >Name <span class="ms-1 text-danger">*</span>
                        </label>
                    ...
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <label class="form-label"
                          >Email Address <span class="ms-1 text-danger">*</span>
                        </label>
                        <input type="text" class="form-control form-control-lg" />
                      </div>
                    </div>
