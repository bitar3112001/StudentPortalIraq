      ...
      <div class="row">
        <div class="col-xl-8 mx-auto">
          ...
          <div class="mb-4">
            ...
            <p class="mb-1 d-flex">
              Data, such as your name, email address, and payment details, collected
              during registration or purchases.
            </p>
            <p class="mb-0 d-flex align-items-center">
              Non-personal data, including device information, browser type, and usage
          ...
          <div class="mb-4">
            ...
            <p class="mb-0 d-flex align-items-center">
              For research, analytics, and marketing (with your consent when required).
            </p>
          </div>
          <div class="mb-4">
            ...
            <p class="mb-0 d-flex align-items-center">
              ...
              essential service providers (e.g., payment processors) or legal obligations.
            </p>
          </div>
          <div class="mb-4">
          ...
          <div class="mb-0">
            ...
            <p class="mb-1">
              We may update this policy and notify you of significant changes through our
              platform or email.
            </p>
            <p class="mb-0">
              For any questions or concerns about this Privacy Policy, contact us at
              <a href="javascript:void(0);" target="_blank">dreamslms@example.com</a>
            </p>
          </div>
        </div>
      </div>
