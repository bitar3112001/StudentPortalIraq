      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          <div class="section-header">
            <span class="fw-medium text-secondary mb-2 d-inline-block section-badge"
              >الأسئلة الشائعة</span
            >
            <h2>الأسئلة المتكررة</h2>
            <p>
              استكشف إجابات مفصلة لأكثر الأسئلة شيوعًا حول منصتنا.
            </p>
          </div>
          <div
            ...
            <div class="accordion-item" data-aos="fade-up">
              ...
              >
                <div class="accordion-body pt-0">
                  <p>
                    تهدف DreamLMS إلى تزويدك بمنصة تعليمية شاملة وبديهية تعزز تجربتك التعليمية.
                  </p>
                </div>
              </div>
            </div>
